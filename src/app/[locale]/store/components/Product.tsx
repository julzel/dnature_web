...
const Product = ({ product, displayCategory }: ProductProps) => {
  const {
    productName,
    category,
    urlSlug,
  ...
  return (
    ...
    >
      ...
      <Box flex={1} flexShrink={0} pt={4} textAlign='right'>
        <Title color='gray.700' type='subtitle' textTransform='uppercase' className={styles.productName} mb={1}>
          {productName}
        </Title>
        <Title color='gray.700' type='subtitle-2' className={styles.productPrice}>
